                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 text-center">
                            ...
                            <a href="https://cekdptonline.kpu.go.id/">https://cekdptonline.kpu.go.id/</a>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Desa</a></h4>
                        <p class="description">Jumlah desa yang terdapat di kabupaten Garut adalah <b>442</b> Desa</p>
                    </div>
                </div>

                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
                    <div class="icon-box">
                        <div class="icon"><img src="<?= $base_url; ?>asset_user/img/4x/logo-tps.png" alt=""></div>
                        <h4 class="title"><a href="">TPS</a></h4>
                        <p class="description">Jumlah TPS yang terdapat di kabupaten Garut adalah <b>8.000</b> TPS</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box">
                        ...
                        <h4 class="title"><a href="">Jumlah Kartu Keluarga</a></h4>
                        <p class="description">Jumlah desa yang terdapat di kabupaten Garut adalah <b>8.000</b> TPS</p>
                </div>
            ...
            <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
                    <div class="icon-box">
                        ...
                        <p class="description">Jumlah total laki-laki dan perempuan yang berada di <?= $row_profil->nama_desa; ?> adalah <b><?= mysqli_num_rows($sql_wanita); ?></b> Jiwa</p>
                    </div>
                </div>
